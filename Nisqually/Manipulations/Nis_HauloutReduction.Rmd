---
title: "Experiment: Haulout Reduction @ Nisqually"
subtitle: "Describing the model run when the number of pinnipeds in the source pool are reduced at Nisqually"
date: "`r format(Sys.time(), '%B %d, %Y')`"
---

### The Narrative

This model run is a scenario where managers or harvesters (or both) implement removals or intensive disturbance at nearby haulouts (the "source pool") which reduces the number of pinnipeds which can access the Gauntlet daily. This scenario would also likely have population-level effects which we are not describing here.
