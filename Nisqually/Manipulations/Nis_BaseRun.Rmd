...
`r raw_arrival_plot + catch_rate_plot`
...
`r gauntlet_plot + escape_plot / fished_plot + eaten_sp_plot`

`r kable(salmon_escapement)`
...
`r plot_seals + plot_ej + plot_zc + plot_layout(guides = "collect")`
