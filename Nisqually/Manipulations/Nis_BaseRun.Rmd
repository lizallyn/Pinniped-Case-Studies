...
parameters <- data.frame(rbind(start_loop, end_loop, days, num_seals, num_zc, num_ej, chum_residence, gr_residence, ln_residence, chin_boats, min_chum_boats, max_chum_boats))
