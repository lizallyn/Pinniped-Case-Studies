...
salmon_colors <- c(Chum = "salmon4", GR = "darkseagreen4", LN = "lightblue3",
                   Chinook = "goldenrod", Coho = "lightblue4", Sockeye = "salmon3")
...
result <- showManipulations(loc = "Nisqually", output = Escape, 150)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.1)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.05)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, -1)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 5)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.5)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.01)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, -10)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 25)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 15)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 200)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.075)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.0005)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.048)
result[[1]]
result[[2]]
...
result <- showManipulations(loc = "Nisqually", output = Escape, 0.07)
result[[1]]
result[[2]]
