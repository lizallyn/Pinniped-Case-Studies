...
long_gauntlet_salmon_sp <- pivot_longer(round(gauntlet_salmon), cols = "Base_chum":"Haulout_LN",
...
gauntlet_salmon <- data.frame(Day = (base_salmon_vars[,"Day"] + (start_loop-1)),
...
long_gauntlet_salmon_sp <- pivot_longer(round(gauntlet_salmon), cols = "Base":"Haulout",
                                 names_to = "Scenario_temp", values_to = "Gauntlet_salmon")
long_gauntlet_salmon_sp$Species <- rep(rep(c("Chum", "Chinook_GR", "Chinook_LN"), each = 4), times = days)
long_gauntlet_salmon_sp$Scenario <- rep(c("Base", "Boat", "Zone", "Haulout"), times = days*3)
