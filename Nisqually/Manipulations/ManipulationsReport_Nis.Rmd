...
Overall, the boat-based harvest and zone management scenarios had the largest improvement in escapement for Chum, but the differences were less pronounced for the two Chinook runs. 

#### Predation

The differences in predation between scenarios also show the largest reduction under the boat-based harvest and zone management scenarios. Predation also noticeably spikes as soon as sea lions arrive in the system on the `r sealion_arrival_date`th day of the year, heightening the differences between scenarios and emphasizing the impact of California sea lions specifically.
...
kable(compare_fished, caption = "Fishery Catch") %>% kable_styling(full_width = F)
```
...
- How to adjust fishing effort in the scenarios. How much in-season management happens? Should they be capped at a quota that is informed by the base run?
