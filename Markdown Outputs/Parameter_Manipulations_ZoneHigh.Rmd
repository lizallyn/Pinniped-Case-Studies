...
This presentation is meant to document single parameter manipulations. The main comparison responses are the number of seals at the Gauntlet and the number of salmon escaped total of each species. The baseline they are compared against is a high efficiency zone exclusion scenario.
...
assembleTheLegos(path_to_pars = "Markdown Outputs/ZoneHigh_set_pars.R", 
