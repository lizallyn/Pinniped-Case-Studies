...
kable(salmon_escapement, caption = "Escaped Salmon") %>% kable_styling(full_width = F, font_size = 14)
```
...
kable(escapement_table, caption = "Escaped Salmon") %>% kable_styling(full_width = F, font_size = 14)
...
```{r step, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
...
```{r decay, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
...
```{r buffer_Pymin_val, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
...
```{r buffer_Pymin_specialist, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
...
```{r buffer_Pxmin_specialist, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
...
```{r num_seals_2_copy, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
...
```{r beta, message = FALSE, echo = FALSE, warning = FALSE, fig.height=4, fig.width = 4}
source("Models/Run_The_Model.R", local = knitr::knit_global())
