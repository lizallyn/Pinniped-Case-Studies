...
escape_4_tab <- rbind(Escape[1,], Escape[nrow(Escape),])
escape_4_tab <- escape_4_tab %>% rename_at("Prob", ~ "Run")
escapement_table <- rbind(base_salmon_escapement, escape_4_tab)
...
escape_4_tab <- rbind(Escape[1,], Escape[nrow(Escape),])
escape_4_tab <- escape_4_tab %>% rename_at("Intercept", ~ "Run")
escapement_table <- rbind(base_salmon_escapement, escape_4_tab)
...
escape_4_tab <- rbind(Escape[1,], Escape[nrow(Escape),])
escape_4_tab <- escape_4_tab %>% rename_at("Threshold", ~ "Run")
escapement_table <- rbind(base_salmon_escapement, escape_4_tab)
...
escape_4_tab <- rbind(Escape[1,], Escape[nrow(Escape),])
escape_4_tab <- escape_4_tab %>% rename_at("Rate", ~ "Run")
escapement_table <- rbind(base_salmon_escapement, escape_4_tab)
