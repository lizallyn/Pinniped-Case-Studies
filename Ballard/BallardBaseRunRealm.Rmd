...
The model runs for `r days` days starting `r as.Date(data_start, origin = "2024-01-01")`. Salmon arrive at the Gauntlet each day according to their run timing - Sockeye arrive earliest in the summer, followed by Chinook and then Coho in the fall. Data on salmon presence at the Gauntlet was provided by the Muckleshoot Tribe. The model then fits a normal curve to the daily salmon arrival data, and those are shown below. The fitted data is what is input into the model.
